 ...
 *
 */
public class LeftGearGroup extends CommandGroup {

    public LeftGearGroup() {
        // Add Commands here:
    	...
    	addSequential(new DriveTimedTank(0.25, 0.265, 2.5));
    	addParallel(new DriveTimedTank(0.1, 0.12, 1.5));
